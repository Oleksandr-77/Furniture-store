...
if (document.body.clientWidth > 1240) {
  ...
  let productItemHeigt = parseInt(
    window.getComputedStyle(document.querySelector(".products__item")).height
  );
  ...
  productsButton.onclick = function () {
    if (productsButton.dataset.view == "close") {
      ...
      products__container.style.height =
        productItemHeigt * 6 + 150 + 150 + "px";
